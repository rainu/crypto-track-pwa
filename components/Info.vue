      ...
      <v-card-text>
        ...
        <v-list-item>
          ...
          <v-list-item-content>
            ...
            <v-list-item-title>{{version}} - <a :href="'https://github.com/rainu/crypto-track-pwa/tree/' + revision.long" target="_blank">{{revision.short}}</a></v-list-item-title>
        ...
        <v-list-item>
          ...
          <v-list-item-content>
            <v-list-item-title>
              <a href="https://github.com/rainu/crypto-track-pwa/issues" target="_blank">{{$t('about.bug')}}</a>
            </v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        ...
        <v-list-item>
          ...
          <v-list-item-content>
            <v-list-item-title>
              <a href="https://github.com/rainu/crypto-track-pwa" target="_blank">{{$t('about.code')}}</a>
            </v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        ...
        <v-list-item>
          ...
          <v-list-item-content>
            ...
            <v-list-item-title>
              <a href="https://github.com/rainu/crypto-track-pwa/blob/master/LICENSE" target="_blank">MIT</a>
            </v-list-item-title>
          </v-list-item-content>
        </v-list-item>
